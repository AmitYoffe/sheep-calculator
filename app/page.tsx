          ...
          <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
            <div>
              ...
              <p className="mt-1 mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Find out how much you're worth in sheep with our fun and
                whimsical calculator!
              </p>
              <div className="mt-6">
                <Link
                  href="#"
          ...
          <div className="container space-y-12 px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-2 text-center">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Simply enter your details and we'll calculate your worth in
                sheep. It's a fun and whimsical way to learn more about
                yourself!
              </p>
            </div>
            <InfoForm />
